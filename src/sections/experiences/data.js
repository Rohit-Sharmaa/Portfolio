...
const experienceData = [
  {
    ...
    location: "Cha-Chi Communications - Gurugram, Delhi",
    description:
      "During my time at Cha-Chi Company, I worked as a Software Developer Intern, contributing to the development of an app. I worked on the backend of the app, focusing on developing authentication systems, securing API endpoints, and optimizing data handling and performance. Additionally, I implemented features to improve load times and enhance user experience. My role also involved ensuring seamless integration of backend functionalities with user interfaces.",
